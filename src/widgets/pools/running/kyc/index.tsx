  ...
  return (
    <Box sx={{ width: "100%" }}>
      <div className="d-flex justify-content-center align-items-center" style={{ width: "100%" }}>
        <Stepper data-testid="activeStep" style={{ width: "300px" }} activeStep={activeStep}>
          {md ? (
            ...
            <CustomText data-testid="steps-activeStep" color="primary" className="ms-5" fs={2}>
              {steps[activeStep]}
            </CustomText>
          )}
        </Stepper>
      ...
      <div>
        <React.Fragment>
          <Row className="justify-content-center my-4 py-4" style={{ height: "60vh", overflow: "scroll" }}>
            <Col data-testid="status-activeStep" xs={10}>
